...
export const MenuItemLoader = (props: IContentLoaderProps) => (
  <ContentLoader
    speed={2}
    width={400}
    height={140}
...
export const HorizontalSectionLoader = (props: IContentLoaderProps) => (
  <ContentLoader
    speed={2}
    width={800}
    height={220}
...
export const SearchLoader = (props: IContentLoaderProps) => {
